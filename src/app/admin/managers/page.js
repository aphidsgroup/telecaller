...
export const metadata = { title: 'Managers - Buildogram Admin' };
  ...
  return (
    <div className="space-y-6">
      <header className="mb-4">
        ...
        <p className="text-sm text-slate-500">Add, edit, and deactivate Manager accounts.</p>
      </header>

      <TelecallerAdmin targetRole="MANAGER" />

      <section>
        <SectionTitle>Current Managers</SectionTitle>
