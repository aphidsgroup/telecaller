...
export const SETTING_DEFS = [
  ...
  { key: 'whatsapp.brochureTemplate', label: 'WhatsApp brochure message', type: 'textarea', group: 'Templates',
    def: 'Hello {{name}}, thank you for your interest in {{project}}. Sharing our brochure and price list here. - Team Buildogram' },
  ...
  { key: 'sheets.autoSyncMinutes', label: 'Auto sync interval (minutes)', type: 'number', def: '5', group: 'Google Sheets' },
];
